...
class CashService:
    ...
    def get_current_or_none(self) -> CashSession | None:
    ...
    def open(self, payload: CashOpenRequest, current_user: User) -> CashSession:
        ...
        cash = CashSession(
            ...
            current_amount_mxn=payload.opening_amount_mxn,
            current_amount_gtq=payload.opening_amount_gtq,
            notes=payload.notes,
    ...
    def close(
        ...
        # Diferencia = contado físico − saldo esperado (sobrante positivo, faltante negativo)
        cash.difference_mxn = payload.closing_amount_mxn - cash.current_amount_mxn
        cash.difference_gtq = payload.closing_amount_gtq - cash.current_amount_gtq
